    ...
    <div class="container-scroller">
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
                <a class="navbar-brand brand-logo me-5" href="{{route('ldash')}}"><img
                        src="{{ asset('assets/images/icons/Pradan-logo-title.png')}}" class="me-2" alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="{{route('ldash')}}"><img
                                                    ...
                                                    <table id="land_table"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><button class="btn btn-warning edit-btn"
                                                                        value="{{$f->id}}">Edit</button>&nbsp;&nbsp;<button
            ...
            <form id="editUserForm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-2">
                            <label>Date of Joining</label>
                            <input type="text" id="edit_date_of_joining" name="date_of_joining" class="form-control"
                                required>
                        </div>
                        <div class="mb-2">
                            <label>Location</label>
